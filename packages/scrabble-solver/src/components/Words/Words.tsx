...
import { selectVerify, useFormatNumber, useTranslate, useTypedSelector } from 'state';
      ...
      <Sidebar.Section
        title={
          <span className={styles.title}>
            ...
            <Badge className={styles.badge}>{formatNumber(invalidWords.length)}</Badge>
          </span>
        }
      >
      ...
      <Sidebar.Section
        title={
          <span className={styles.title}>
            ...
            <Badge className={styles.badge}>{formatNumber(validWords.length)}</Badge>
          </span>
        }
      >
