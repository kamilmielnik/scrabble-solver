...
export const selectShowWalkthrough = createSelector(selectRoot, ({ showWalkthrough }) => showWalkthrough);

export const selectTranslations = createSelector(selectState, (state) => ({
...
export const selectSteps = createSelector(selectTranslations, (translations) => [
  {
